...
// Extracted Tabs
import 'editor_tabs/curator_settings_tab.dart';
import 'editor_tabs/curator_order_tab.dart';
import 'editor_tabs/curator_upload_tab.dart';
import 'editor_tabs/ocr_entities_tab.dart';
...
class _FanzineCuratorWidgetState extends State<FanzineCuratorWidget> with SingleTickerProviderStateMixin {
  ...
  Widget _buildActiveTab(BuildContext context, Fanzine fanzine, List<FanzinePage> pages) {
    switch (_tabController.index) {
      case 0: return CuratorSettingsTab(fanzineId: widget.fanzineId, fanzine: fanzine);
      case 1: return CuratorOrderTab(pages: pages);
      case 2: return CuratorUploadTab(fanzineId: widget.fanzineId, folioTitle: fanzine.title);
      case 3: return OcrEntitiesTab(fanzine: fanzine);
