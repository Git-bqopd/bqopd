        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Owner: ${fanzine.ownerId == context.read<UserProvider>().currentUserId ? 'You' : fanzine.ownerId}",
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          isPending ? "Processing Assets..." : "Archival Page",
  ...
  Widget _buildOCREntitiesTab(BuildContext context, Fanzine fanzine, List<FanzinePage> pages) {
    if (fanzine.type == FanzineType.folio || fanzine.type == FanzineType.calendar) {
      return const Padding(
        ...
        child: Text(
          "Automated OCR and Entity Extraction pipelines are not applicable for manually assembled Folios.",
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection('images')
          .where('usedInFanzines', arrayContains: fanzine.id)
          .snapshots(),
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          for (var doc in snapshot.data!.docs) {
            ...
            if (data['text_raw'] != null && data['text_raw'].toString().isNotEmpty) {
              rawDone++;
            }
            if (data['text_corrected'] != null && data['needs_ai_cleaning'] != true) {
              masterVerified++;
            }
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text(
              isDirect ? "DELETE FOREVER" : "REMOVE",
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () => showDialog(
            context: context,
            builder: (c) => _CuratorAssetEditModal(imageId: doc.id, data: data),
          ),
          child: Stack(
            fit: StackFit.expand,
            children: [
