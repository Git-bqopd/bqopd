...
class MakerUploadTab extends StatefulWidget {
  final String fanzineId;
  final String folioTitle;

  const MakerUploadTab({super.key, required this.fanzineId, required this.folioTitle});

  @override
  State<MakerUploadTab> createState() => _MakerUploadTabState();
}

class _MakerUploadTabState extends State<MakerUploadTab> {
