...
class EditTextPanel extends StatefulComponent {
  ...
  @override
  State<EditTextPanel> createState() => _EditTextPanelState();
}

class _EditTextPanelState extends State<EditTextPanel> {
  String _textValue = '';
  ...
  @override
  void didUpdateComponent(EditTextPanel oldComponent) {
  ...
  Future<void> _loadText() async {
    ...
    try {
      ...
      if (doc['exists'] && mounted) {
        ...
        setState(() {
          // FIXED: Prioritize text_linked (fully formatted + bracketed wiki-links) to prevent wiping out links on load/save!
      ...
      print('[EDIT TEXT PANEL ERROR] Loading failed: $e');
      setState(() {
        _textValue = '';
        _loading = false;
      });
  ...
  Future<void> _saveText() async {
    ...
    try {
      ...
      print('[EDIT TEXT PANEL ERROR] Save failed: $e');
      if (mounted) {
        setState(() {
          _isSaving = false;
