...
/// Renders a two-page spread row tile in the fanzine grid view.
  ...
  Component build(BuildContext context) {
    ...
    return div(
      ...
      [
        ...
        if (isHeaderRow)
          div(
            classes: 'header-envelope-overlay',
            [
              div(
                classes: 'manila-envelope-cover',
                [leftWidget!],
              ),
            ],
          ),
    ...
    return div(
      ...
      [
        if (url != null && url.isNotEmpty)
          ...
          p(
            classes: 'text-gray text-xs',
            [Component.text('Page $pageNum')],
          ),
      ],
    );
  }
