      ...
      [
        ...
        div(
          [
            button(
              [
                span([Component.text('arrow_back')], classes: 'material-symbols-outlined', attributes: const {'style': 'font-size: 18px; margin-right: 4px;'}),
            ...
            h2([Component.text("publish single image")], classes: 'font-bold text-sm text-black', attributes: const {'style': 'margin: 0; margin-left: auto; text-transform: lowercase; font-variant: small-caps;'}),
          ],
        ...
        div(
          [
            ...
            div(
              [
                if (_selectedObjectUrl != null)
                  ...
                  div(
                    [
                      span([Component.text('add_photo_alternate')], classes: 'material-symbols-outlined text-gray-400', attributes: const {'style': 'font-size: 48px;'}),
                      p([Component.text("Click to select image file from device")], attributes: const {'style': 'font-size: 11px; color: #777; font-weight: bold; margin-top: 8px; margin-bottom: 0;'}),
                    ],
                    attributes: const {
            ...
            if (_selectedFileName != null)
              div(
                [
                  span([Component.text('file_present')], classes: 'material-symbols-outlined text-gray-500', attributes: const {'style': 'font-size: 16px; margin-right: 4px;'}),
                  span([Component.text("Selected: $_selectedFileName ($_imageWidth x $_imageHeight)")]),
                ],
                attributes: const {
            ...
            div(
              [
                span([Component.text("IMAGE TITLE")], classes: 'text-xs font-bold text-gray-600', attributes: const {'style': 'margin-bottom: 4px; display: block;'}),
                input(
                  attributes: {
                    'type': 'text',
            ...
            div(
              [
                span([Component.text("CAPTION / DESCRIPTION")], classes: 'text-xs font-bold text-gray-600', attributes: const {'style': 'margin-bottom: 4px; display: block;'}),
                input(
                  attributes: {
                    'type': 'text',
            ...
            div(
              [
                span([Component.text("INDICIA / HISTORICAL DESCRIPTION")], classes: 'text-xs font-bold text-gray-600', attributes: const {'style': 'margin-bottom: 4px; display: block;'}),
                textarea(
            ...
            div(
              [
                span([Component.text("CREATORS & CONTRIBUTORS")], classes: 'text-xs font-bold text-gray-600', attributes: const {'style': 'margin-bottom: 6px; display: block;'}),
                  ...
                  div(
                    [
                      for (int i = 0; i < _blocState.creators.length; i++)
                        div(
                          [
                            span([Component.text('${_blocState.creators[i]['name']} (${_blocState.creators[i]['role']})')]),
                            button(
                              [span([Component.text('remove_circle')], classes: 'material-symbols-outlined text-red-500', attributes: const {'style': 'font-size: 16px;'})],
                ...
                div(
                  [
                    ...
                    button(
                      [span([Component.text('add_circle')], classes: 'material-symbols-outlined text-green-600', attributes: const {'style': 'font-size: 24px;'})],
                      classes: 'cursor-pointer border-none bg-transparent',
                      events: {
                        'click': (e) => _addCreator()
                      },
            ...
            if (errorMessage != null)
              p([Component.text(errorMessage)], attributes: const {'style': 'font-size: 12px; color: #ef4444; font-weight: bold; margin-bottom: 12px;'}),
            if (isUploading)
              div(
                [
            ...
            button(
              [
                if (isUploading)
                  ...
                  span([Component.text('cloud_upload')], classes: 'material-symbols-outlined', attributes: const {'style': 'font-size: 18px; margin-right: 6px;'}),
                Component.text(isUploading ? "publishing image..." : "publish to gallery")
              ],
