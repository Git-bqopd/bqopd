...
class _SettingsSocialButtonsPageState extends State<SettingsSocialButtonsPage> {
  ...
  Component _buildPillBadge(String label, String bgColor, String textColor, String borderColor) {
    return span(
      ...
      attributes: {
        'style':
        'font-size: 10px; font-weight: 600; color: $textColor; background-color: $bgColor; border: 1px solid $borderColor; padding: 2px 7px; border-radius: 4px; text-transform: lowercase; white-space: nowrap; line-height: 1.2; letter-spacing: 0.2px; text-align: center; max-width: 100px; overflow: hidden; text-overflow: ellipsis;',
      },
    );
  }
  ...
  Component _buildColumnChip(String colKey, String label) {
    ...
    return button(
      ...
      attributes: {
        'type': 'button',
        'style':
        'height: 28px; padding: 0 12px; font-size: 11px; font-weight: bold; border-radius: 100px; cursor: pointer; text-transform: lowercase; border: ${isSelected ? "none" : "1px solid #79747E"}; background-color: ${isSelected ? "#E8DEF8" : "#ffffff"}; color: ${isSelected ? "#1D192B" : "#49454F"}; display: inline-flex; align-items: center; gap: 4px;',
      },
      events: {
        'click': (e) {
          setState(() {
  ...
  Component _buildContextToggleChip(String label, bool isSelected, VoidCallback onToggle) {
    return button(
      ...
      attributes: {
        'type': 'button',
        'style':
        'height: 24px; padding: 0 10px; font-size: 10px; font-weight: bold; border-radius: 100px; cursor: pointer; text-transform: lowercase; border: ${isSelected ? "none" : "1px solid #ccc"}; background-color: ${isSelected ? "#E8DEF8" : "#ffffff"}; color: ${isSelected ? "#1D192B" : "#666"}; display: inline-flex; align-items: center; gap: 4px;',
      },
  ...
  Component _buildSocialButtonCardRow(ReaderTool tool, int index) {
    ...
    return div(
      ...
      attributes: const {
        'style':
        'display: flex; flex-direction: row; align-items: center; gap: 12px; padding: 8px 12px; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; min-height: 48px; box-sizing: border-box; width: 100%; transition: background-color 0.15s ease;',
      },
      [
        // Icon circular badge
        div(
          attributes: const {
            'style':
            'display: flex; align-items: center; justify-content: center; width: 34px; height: 34px; border-radius: 50%; border: 1.5px solid #000; flex-shrink: 0; background-color: #ffffff;'
          },
          [
            if (isSvgAsset)
              img(
              ...
              span(
                ...
                [Component.text(cleanIconName(iconPath))],
              )
          ],
        ),
        ...
        div(
          attributes: const {
            'style':
            'display: flex; flex-direction: column; justify-content: center; flex: 1; overflow: hidden;'
          },
          [
            div(
              [Component.text(tool.label.toLowerCase())],
              attributes: const {
                'style':
                'font-size: 13px; font-weight: bold; color: #000; line-height: 1.2; text-transform: lowercase;'
              },
            ),
            div(
              [Component.text(tool.description)],
              attributes: const {
                'style':
                'font-size: 11px; color: #6b7280; line-height: 1.3; margin-top: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'
              },
            )
          ],
        ),
        ...
        for (var colKey in _visibleColumns)
          div(
            attributes: const {
              'style':
              'width: 110px; display: flex; justify-content: center; align-items: center; flex-shrink: 0;'
            },
            [
              if (colKey == 'position')
    ...
    return div(
      [
        ...
        div(
          ...
          attributes: const {
            'style':
            'display: flex; flex-direction: column; gap: 16px; width: 100%; border-bottom: 2px solid #e5e7eb; padding-bottom: 24px;'
          },
          [
            ...
            div(
              ...
              attributes: const {
                'style':
                'display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 8px; width: 100%;'
              },
              [
                span(
                  [Component.text("LIVE APP TOOLBAR SIMULATION")],
                  attributes: const {
                    'style':
                    'font-size: 11px; font-weight: bold; color: #374151; letter-spacing: 0.5px;'
                  },
                ),
                div(
                  attributes: const {
                  ...
                  [
                    span(
                      [Component.text("simulate:")],
                      attributes: const {
                        'style':
                        'font-size: 10px; color: #888; font-weight: bold; margin-right: 2px;'
                      },
                    ),
            ...
            div(
              ...
              [
                div(
                  ...
                  [
                    span(
                      [Component.text("FanzineReaderPage (Public Reader)")],
                      attributes: const {
                        'style':
                        'font-size: 11px; font-weight: bold; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px;'
                      },
                    ),
                    span(
                      [Component.text("ToolScope.reader | ingested")],
                      attributes: const {
                ...
                div(
                  ...
                  attributes: const {
                    'style':
                    'background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 8px; width: 100%; box-sizing: border-box;'
                  },
                  [
                    SocialToolbar(
                      ...
                      onToggleBonusRow: (row) {
                        setState(() {
                          _previewReaderBonusRow =
                          (_previewReaderBonusRow == row) ? null : row;
                        });
                      },
                      likedImageIds: const {},
                    )
            ...
            div(
              ...
              [
                div(
                  ...
                  [
                    span(
                      [Component.text("FanzineCurator (Curator Workspace)")],
                      attributes: const {
                        'style':
                        'font-size: 11px; font-weight: bold; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px;'
                      },
                    ...
                    span(
                      [Component.text("ToolScope.curator | ingested")],
                      attributes: const {
                        'style': 'font-size: 10px; color: #9ca3af; font-family: monospace;'
                      },
                    ),
                ...
                div(
                  ...
                  [
                    SocialToolbar(
                      ...
                      onToggleBonusRow: (row) {
                        setState(() {
                          _previewCuratorBonusRow =
                          (_previewCuratorBonusRow == row) ? null : row;
                        });
                      },
                      likedImageIds: const {},
                    )
            ...
            div(
              ...
              [
                div(
                  ...
                  [
                    span(
                      [Component.text("FanzineEditor (Maker / Folio Workspace)")],
                      attributes: const {
                        'style':
                        'font-size: 11px; font-weight: bold; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px;'
                      },
                    ...
                    span(
                      [Component.text("ToolScope.editor | folio")],
                      attributes: const {
                        'style': 'font-size: 10px; color: #9ca3af; font-family: monospace;'
                      },
                    ),
                ...
                div(
                  ...
                  [
                    SocialToolbar(
                      ...
                      onToggleBonusRow: (row) {
                        setState(() {
                          _previewEditorBonusRow =
                          (_previewEditorBonusRow == row) ? null : row;
                        });
                      },
                      likedImageIds: const {},
                    )
        ...
        div(
          ...
          attributes: const {
            'style':
            'display: flex; justify-content: space-between; align-items: center; width: 100%; margin-bottom: 16px; border-bottom: 1px solid #eee; padding-bottom: 12px; flex-wrap: wrap; gap: 12px;'
          },
          [
            div([
              span(
                [Component.text("TARGET VIEWPORT PANEL")],
                attributes: const {
                  'style':
                  'font-size: 11px; font-weight: bold; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px; display: block;'
                },
              ),
              span(
                [Component.text("inspect mobile bonus row drawer vs desktop 3rd column targets")],
            ...
            div(
              attributes: const {
                'style':
                'display: flex; border: 1px solid #ccc; border-radius: 100px; overflow: hidden; background: white;'
              },
              [
                button(
                  [
                    ...
                    Component.text("bonus row (mobile)")
                  ],
                  attributes: {
                    'type': 'button',
                    'style':
                    'border: none; padding: 6px 14px; font-size: 11px; font-weight: bold; cursor: pointer; display: inline-flex; align-items: center; '
                ...
                button(
                  [
                    span(
                      ...
                      [Component.text('desktop_windows')],
                    ),
                    Component.text("bonus column (desktop)")
                  ],
                  attributes: {
                    'type': 'button',
                    'style':
        ...
        div(
          ...
          attributes: const {
            'style':
            'display: flex; flex-direction: column; gap: 8px; width: 100%; margin-bottom: 16px;'
          },
          [
            span(
              [Component.text("FEATURE / CONTEXT COLUMNS")],
              attributes: const {
                'style':
                'font-size: 11px; font-weight: bold; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px;'
              },
        ...
        if (_visibleColumns.isNotEmpty)
          div(
            attributes: const {
              'style':
              'display: flex; flex-direction: row; align-items: center; padding: 0 12px 8px 12px; border-bottom: 2px solid #e5e7eb; width: 100%; box-sizing: border-box;'
            },
            [
              div(
                [Component.text("BUTTON / PANEL")],
                attributes: const {
                  'style':
                  'flex: 1; font-size: 11px; font-weight: bold; color: #6b7280; text-transform: uppercase;'
                },
              ),
              for (var colKey in _visibleColumns)
                div(
                  [Component.text(_matrixColumnLabels[colKey] ?? colKey)],
                  attributes: const {
                    'style':
                    'width: 110px; text-align: center; font-size: 10px; font-weight: bold; color: #6b7280; text-transform: uppercase; flex-shrink: 0; padding: 0 4px;'
                  },
                )
            ],
          ),
      ...
      attributes: const {
        'style':
        'display: flex; flex-direction: column; gap: 16px; padding: 24px; background: white; box-sizing: border-box;'
      },
    );
  }
}