...
JSFunction fsListenDoc(String path, void Function(String) callback) {
...
JSFunction fsListenQuery(String path, String field, String op, String valueJson, String orderBy, bool desc, void Function(String) callback) {
...
/// Emits specially formatted objects that the JS bridge intercepts and translates into real Firebase FieldValues.
class WebFieldValue {
