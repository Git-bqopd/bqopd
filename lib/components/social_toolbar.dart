...
class SocialToolbar extends StatefulWidget {
  ...
  final VoidCallback? onToggleIndicia; // Callback used to determine visibility
            ...
            child: Row(
              ...
              children: [
                ...
                if (widget.isEditingMode) ...[
                  ...
                  // UPDATED: Check for callback presence to hide on non-indicia pages
                ...
                child: Row(
                  ...
                  children: [
                    if (widget.isEditingMode) ...[
                      ...
                      _DrawerItem(
                          label: 'Indicia',
                          icon: Icons.copyright, // Updated Icon
