              ...
              children: [
                ...
                if (widget.isEditingMode) ...[
                  ...
                  if (buttonVisibility['OCR'] == true) ...[
                    SocialActionButton(icon: Icons.document_scanner, label: 'OCR', onTap: widget.onToggleOCR),
                    const SizedBox(width: 16),
                  ],
                  ...
                  SocialActionButton(icon: Icons.visibility, label: 'Read', onTap: widget.onToggleEditMode),
                  const SizedBox(width: 16),
                ] else ...[
                    ...
                    StreamBuilder<bool>(
                      ...
                      builder: (context, likedSnap) {
                        ...
                        return StreamBuilder<DocumentSnapshot>(
                          stream: FirebaseFirestore.instance.collection('fanzines').doc(widget.fanzineId).collection('pages').doc(widget.pageId).snapshots(),
                          builder: (context, pageSnap) {
                            ...
                            return SocialActionButton(icon: isLiked ? Icons.favorite : Icons.favorite_border, label: 'Like', isActive: isLiked, count: count, onTap: () => _handleLike(isLiked));
                          },
                        );
                      },
                    )
                    ...
                    if (widget.imageId != null && widget.imageId!.isNotEmpty)
                      StreamBuilder<DocumentSnapshot>(
                        ...
                        builder: (context, imgSnap) {
                          ...
                          return SocialActionButton(icon: Icons.comment, label: 'Comment', count: count, onTap: widget.onToggleComments);
                        },
                      )
                    else
                    ...
                    if (widget.imageId != null && widget.imageId!.isNotEmpty)
                      StreamBuilder<DocumentSnapshot>(
                        ...
                        builder: (context, imgSnap) {
                          ...
                          return SocialActionButton(icon: Icons.show_chart, label: 'Views', count: count, onTap: widget.onToggleViews);
                        },
                      )
                    else
                  ...
                  if (isEditor && buttonVisibility['Edit'] != false) ...[
                    SocialActionButton(icon: Icons.edit, label: 'Edit', onTap: widget.onToggleEditMode),
                    const SizedBox(width: 16),
                  ],
                ],
                ...
                child: Row(
                  ...
                  children: [
                    if (widget.isEditingMode) ...[
                      ...
                      _DrawerItem(label: 'OCR', icon: Icons.document_scanner, isSelected: buttonVisibility['OCR'] ?? false, onTap: () => userProvider.toggleSocialButton('OCR')),
                      const SizedBox(width: 10),
                      _DrawerItem(label: 'Entities', icon: Icons.person_search, isSelected: buttonVisibility['Entities'] ?? false, onTap: () => userProvider.toggleSocialButton('Entities')),
                      const SizedBox(width: 10),
                      ...
                      if (isEditor) ...[
                        ...
                        const SizedBox(width: 10),
                        _DrawerItem(label: 'Edit', icon: Icons.edit, isSelected: buttonVisibility['Edit'] ?? true, onTap: () => userProvider.toggleSocialButton('Edit')),
                      ],
                    ],
                  ],
                ),
