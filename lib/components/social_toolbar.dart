...
class SocialToolbar extends StatefulWidget {
  ...
  final bool isEditingMode; // Track if we are in editor view
  final VoidCallback? onToggleEditMode; // Callback to switch modes
            ...
            child: Row(
              ...
              children: [
                ...
                if (widget.isEditingMode) ...[
                  ...
                  // Use "Read" to exit editing mode - Placed at the end of the row
                  SocialActionButton(
                  ...
                  if (buttonVisibility['Circulation'] == true) ...[
                    const SocialActionButton(
                        icon: Icons.print, label: 'Circulation'),
                    const SizedBox(width: 16),
                  ],
                  ...
                  children: [
                    if (widget.isEditingMode) ...[
                      _DrawerItem(
                          ...
                          onTap: () =>
                              userProvider.toggleSocialButton('Text')),
                      ...
                      if (isEditor) ...[
                        ...
                        Container(
                            height: 30,
                            width: 2,
                            color: Colors.grey.shade300), // Separator
                        const SizedBox(width: 10),
                        _DrawerItem(
                            label: 'Edit',
                            icon: Icons.edit,
                            ...
                            onTap: () =>
                                userProvider.toggleSocialButton('Edit')),
                      ],
                    ],
                  ],
                ),
