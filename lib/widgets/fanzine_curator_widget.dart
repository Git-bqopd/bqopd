...
class FanzineCuratorWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _FanzineCuratorView(fanzineId: fanzineId),
    );
  }
}

class _FanzineCuratorView extends StatefulWidget {
  final String fanzineId;
  const _FanzineCuratorView({required this.fanzineId});

  @override
  State<_FanzineCuratorView> createState() => _FanzineCuratorViewState();
}

class _FanzineCuratorViewState extends State<_FanzineCuratorView>
